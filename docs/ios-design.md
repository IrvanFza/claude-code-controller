...
This document is the single source of truth for the Companion iOS redesign. It copies the Grok Bot design language faithfully — the owner's explicit direction — and adapts it to the Companion stack (apps/ios, SwiftUI, CompanionKit). Every value is extracted from nine reference screens (5 App Store, 4 owner-provided) and the cursor.com/help/grok-bot UX documentation.
